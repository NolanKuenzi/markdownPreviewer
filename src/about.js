...
function About() {
  return (
    <div id="aboutDiv">
      ...
      app's Markdown Output section, using the Marked Library (version 0.4.0).</h4><p>To use the app users simply need to enter markdown into the input section and it will apear as html in the output section. 
